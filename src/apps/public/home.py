...
youtube_id = config["general"]["YOUTUBE_VIDEO_ID"]
...
def home():
    ...
    st.image("assets/image.gif",
             caption='Empower Your Digital Life with Jarvis', use_container_width=True)
    ...
    with st.expander("## See Jarvis in Action"):
        st.video(f'https://www.youtube.com/watch?v={youtube_id}', start_time=0)
